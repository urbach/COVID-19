...
## 52 is 20
bonn[c(40:length(ii))] <- c(1, 1, 1, 1, 1, 1, 2, 4, 5, 6, 13, 18, 20, 36, 37, 55, 64, 76, 92, 119, 132, 151, 161, 180, 205, 222, 241, 259, 268, 272, 294, 294, 353, NA)
...
legend("topleft",
       legend=c("Daten Deutschland", "Fit2", "Fit3"),
       bty="n", col=c("black", "blue", "darkgreen"),
       pch=c(21, NA, NA), lty=1)
...
Wiederum die gleichen Daten als Änderung zum Vortrag aufgetragen.
...
Frankreich und die USA sich gleich verhalten, was ungefähr bis Tag 60
annehmbar wäre, können wir über die vier Länder
