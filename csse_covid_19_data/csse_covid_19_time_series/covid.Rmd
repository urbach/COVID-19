...
## 52 is 20
bonn[c(40:length(ii))] <- c(1, 1, 1, 1, 1, 1, 2, 4, 5, 6, 13, 18, 20, 36, 37, 55, 64, 76, 92, 119, 132, 151, 161, 180, 205, 222, 241, 259, 268, NA)
...
legend("topleft",
       ...
       bty="n", col=c("black", "red", "blue", "darkgreen"), lty=1)
