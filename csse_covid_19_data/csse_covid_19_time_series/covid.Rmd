...
## 52 is 20
bonn[c(40:length(ii))] <- c(1, 1, 1, 1, 1, 1, 2, 4, 5, 6, 13, 18, 20, 36, 37, 55, 64, 76, 92, 119, 132, 151, 161, 180, 205, 222, 241, 259, 268, 272, 294, 294, 353, 370, 395, 412, 416, 417, 447, 474, 484, 504, 518, 530, 539, 550, 552, 561, 570, 573, 573, 580, 580, NA)
...
abline(h=1)
legend("topright",
       legend=c(expression(R[1]), expression(R[4])),
       bty="n", pch=c(21,22), col=c("red", "blue"))
```
