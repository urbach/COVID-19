...
## 52 is 20
bonn[c(40:length(ii))] <- c(1, 1, 1, 1, 1, 1, 2, 4, 5, 6, 13, 18, 20, 36, 37, 55, 64, 76, 92, 119, 132, 151, 161, 180, 205, 222, 241, 259, 268, 272, 294, 294, 353, 370, 395, 412, 416, NA)
...
plot(y=as.vector(colSums(xdata[grepl("China", x=xdata$Country.Region),ii]))/sum(xdata[grepl("China", x=xdata$Country.Region),ii[1]]), x=x,
     log="y", type='l', ylim=c(1,500), xlim=c(0,20),
...
plot(y=cdata, x=x[jj-4],
     log="y", type='l', ylim=c(1,500000),
     xlab=c("Tage seit 22.01.2020"), ylab="C")
...
barplot(height=c(NA, inc), ylab="Äanderung zum Vortag", xlab="Tage seit 22.01.2020", names.arg=x[jj-4],
        col="red")
```
...
##plot(y=c(NA, inc), x=x[jj-4], xlab="Tage seit 22.01.2020", ylab="Äanderung zum Vortag")
##lines(y=c(NA, inc), x=x[jj-4])
barplot(height=c(NA, incav), ylab="Äanderung zum Vortag (gemittelt)", xlab="Tage seit 22.01.2020", names.arg=x[jj-4],
        col="blue")
```
...
x <- c(1:length(nrw$V1))
plot(NA, xlim=range(x), ylim=c(1,10*range(nrw$V2)[2]), xlab="Datum", ylab="Fälle", log="y", xaxt="n")

ii <- seq(3, length(nrw$V1), by=5)
axis(side=1,
     at=ii, lwd.ticks=1.5,
     labels=nrw$V1[ii])
...
lines(x=x, y=nrw$V2, col="red", lty=1)
points(x=x, y=nrw$V2, col="red", pch=21)

lines(x=x, y=bn$V2, col="blue", lty=2)
points(x=x, y=bn$V2, col="blue", pch=22)

lines(x=x, y=kn$V2, col="darkgreen", lty=3)
points(x=x, y=kn$V2, col="darkgreen", pch=23)

lines(x=x, y=df$V2, col="darkorange", lty=4)
points(x=x, y=df$V2, col="darkorange", pch=24)

lines(x=x, y=hb$V2, col="black", lty=5)
points(x=x, y=hb$V2, col="black", pch=25)
