...
## 52 is 20
bonn[c(40:53)] <- c(1, 1, 1, 1, 1, 1, 2, 4, 5, 6, 13, 18, 20, 36)
...
plot(y=as.vector(colSums(xdata[grepl("China", x=xdata$Country.Region),ii]))/sum(xdata[grepl("China", x=xdata$Country.Region),ii[1]]), x=x,
     log="y", type='l', ylim=c(1,250), xlim=c(0,20),
...
kable(data.frame(stripX(colnames(xdata)[ii])[kk], gdata[kk], bonn[kk]),
